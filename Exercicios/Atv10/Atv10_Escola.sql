-- Atividade 10 do curso de Dev FullStack Jr da +praTI
...
INSERT INTO Alunos (nome, curso, nivel, idade) VALUES
	('Patolino', 'Engenharia da Computação', 'Mestrado', 22),
...
-- 2. Quais os números das matrículas dos alunos?
SELECT aluno_id AS Numero_Matricula, nome FROM Alunos;

-- 3. Quais os números das matrículas dos alunos que não estão matriculados em uma turma?    
SELECT A.aluno_id AS Numero_Matricula FROM Alunos A
