-- Atividade 11 do curso de Dev FullStack Jr da +praTI
...
-- Uma comanda tem um código único, data, o número da mesa do cliente e o nome do cliente registrados. Nos itens da comanda
-- é possível relacionar vários cafés listados no cardápio que foram vendidos. Cada item da comanda possui o código do cardápio e
-- a quantidade requisitada deste e, não é possível inserir o mesmo código de cardápio mais de uma vez na mesma comanda. No cardápio
-- é apresentado o nome único do café, a descrição da sua composição e o preço unitário.

CREATE DATABASE BomGosto11;
USE BomGosto11;
