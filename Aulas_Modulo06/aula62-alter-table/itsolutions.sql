...
CREATE TABLE IF NOT EXISTS `mydb`.`Recurso` (
  ...
  `HistoricoSalario_idHistoricoSalario` INT NOT NULL,
  `Equipe_idEquipe1` INT NOT NULL,
  PRIMARY KEY (`idRecurso`, `Equipe_idEquipe`),
  INDEX `fk_Recurso_Cargo_idx` (`Cargo_idCargo` ASC),
  INDEX `fk_Recurso_Endereco1_idx` (`Endereco_idEndereco` ASC),
  INDEX `fk_Recurso_HistoricoSalario1_idx` (`HistoricoSalario_idHistoricoSalario` ASC),
  INDEX `fk_Recurso_Equipe1_idx` (`Equipe_idEquipe1` ASC),
  ...
  CONSTRAINT `fk_Recurso_Endereco1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Recurso_HistoricoSalario1`
    FOREIGN KEY (`HistoricoSalario_idHistoricoSalario`)
    REFERENCES `mydb`.`HistoricoSalario` (`idHistoricoSalario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Contato` (
  ...
  INDEX `fk_Contato_Recurso1_idx` (`Recurso_idRecurso` ASC, `Recurso_Equipe_idEquipe` ASC),
  CONSTRAINT `fk_Contato_Recurso1`
    FOREIGN KEY (`Recurso_idRecurso` , `Recurso_Equipe_idEquipe`)
    REFERENCES `mydb`.`Recurso` (`idRecurso` , `Equipe_idEquipe`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Projeto` (
  ...
  INDEX `fk_Projeto_Recurso1_idx` (`Recurso_idGerente` ASC),
...
-- -----------------------------------------------------
-- Table `mydb`.`FerramentaProg`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`FerramentaProg` (
...
-- -----------------------------------------------------
-- Table `mydb`.`RecursoFerramentaProg`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`RecursoFerramentaProg` (
  `idRecursoFerramenta` INT NOT NULL AUTO_INCREMENT,
  `Recurso_idRecurso` INT NOT NULL,
  `FerramentaProg_idFerramenta` INT NOT NULL,
  PRIMARY KEY (`idRecursoFerramenta`),
  INDEX `fk_RecursoFerramentaProg_Recurso1_idx` (`Recurso_idRecurso` ASC),
  INDEX `fk_RecursoFerramentaProg_FerramentaProg1_idx` (`FerramentaProg_idFerramenta` ASC),
  ...
  CONSTRAINT `fk_RecursoFerramentaProg_FerramentaProg1`
    FOREIGN KEY (`FerramentaProg_idFerramenta`)
    REFERENCES `mydb`.`FerramentaProg` (`idFerramenta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tarefa` (
  ...
  INDEX `fk_Tarefa_Atividade1_idx` (`Atividade_idAtividade` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`ProjetoAtividade` (
  ...
  INDEX `fk_ProjetoAtividade_Atividade1_idx` (`Atividade_idAtividade` ASC),
  INDEX `fk_ProjetoAtividade_Projeto1_idx` (`Projeto_idProjeto` ASC),
