...
CREATE TABLE IF NOT EXISTS `mydb`.`Recurso` (
  ...
  INDEX `fk_Recurso_HistoricoSalario1_idx` (`HistoricoSalario_idHistoricoSalario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`RecursoFerramentaProg` (
  ...
  INDEX `fk_RecursoFerramentaProg_FerramentaProg1_idx` (`FerramentaProg_idFerramenta` ASC) VISIBLE,
